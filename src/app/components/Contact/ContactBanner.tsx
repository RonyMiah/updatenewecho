...
import contactBannerImage from '@/assets/contact-banner-img.png'
        ...
        <div className="container mx-auto px-4 py-8 flex flex-col lg:flex-row items-center">
          ...
          <div className="lg:w-1/2 text-center lg:text-left mx-auto">
            ...
            <p className="text-gray-700 mb-6 text-xl ">
              We&apos;re here to help you achieve a cleaner, healthier space.
              Whether you have questions, need a quote, or want to schedule a
              service, our friendly team is ready to assist you. Contact us
              today, and experience the difference with our top-quality cleaning
